        ...
        for k in data:
            ...
            if data[k][0] == 'added':
                if isinstance(data[k][1], dict):
                    lines.append(
                        f'Property \'{current_path}{k}\' was added with value: '
                        f'[complex value]'
                    )
                else:
                    lines.append(
                ...
                if isinstance(data[k][1], dict) \
                    ...
                    lines.append(
                        f'Property \'{current_path}{k}\' was updated. From [complex value] '
                        f'to {data[k][2]}'
                    )
                elif isinstance(data[k][2], dict) \
                        and not isinstance(data[k][1], dict):
                    lines.append(
                        f'Property \'{current_path}{k}\' was updated. From {data[k][1]} '
                        f'to [complex value]'
                    )
